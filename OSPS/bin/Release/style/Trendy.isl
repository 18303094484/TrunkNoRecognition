    ...
    <styleSet name="Default" buttonStyle="FlatBorderless" useOsThemes="False" useFlatMode="True">
      <componentStyles>
        ...
        <componentStyle name="Inbox MonthCalendar">
          <properties>
            <property name="TitleBackColor">112, 188, 18</property>
          </properties>
        </componentStyle>
        ...
        <componentStyle name="UltraGrid">
          <properties>
            <property name="AddNewBoxButtonConnectorStyle">None</property>
          </properties>
        </componentStyle>
      ...
      <styles>
        <style role="Base">
          <states>
            <state name="Normal" foreColor="DimGray" fontName="Arial" textVAlign="Middle" fontSize="8" themedElementAlpha="Transparent" />
          </states>
        </style>
        <style role="Button">
          <states>
