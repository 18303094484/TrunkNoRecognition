...
namespace OSPS.Device.HikCamera
{
    /// <summary>
    /// CHCNetSDK 的摘要说明。
    /// </summary>
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        {
            public uint dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = CID_CODE_LEN)]
            public string sCIDCode;    //CID事件号
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = NAME_LEN)]
            public string sCIDDescribe;    //CID事件名
            public NET_DVR_TIME_EX struTriggerTime;            //触发报警的时间点
            public NET_DVR_TIME_EX struUploadTime;                //上传报警的时间点
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = ACCOUNTNUM_LEN)]
            public string sCenterAccount;    //中心帐号
            public byte byReportType;                    //见定义NET_DVR_ALARMHOST_REPORT_TYPE
            public byte byUserType;                        //用户类型，0-网络用户 1-键盘用户,2-手机用户,3-系统用户
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = NAME_LEN)]
            public string sUserName;        //网络用户用户名
            ...
            public byte byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = ACCOUNTNUM_LEN_32)]
            public string sCenterAccountV40;    //中心账号V40,使用此字段时sCenterAccount无效
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 28, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
        }
